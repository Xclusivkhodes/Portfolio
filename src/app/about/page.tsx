...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "xclusivkhoder@gmail",
    href: "mailto:xclusivkhoder@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/xclusivkhodes/",
    content: "/felix-gbewonyo",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/xclusivkhodes",
    content: "/felix-gbewonyo",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Gbewonyo Felix</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Felix, a Fullstack developer passionate about
